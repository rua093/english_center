        ...
        <div class="mx-auto w-full max-w-[1450px] px-4 sm:px-6 flex min-h-[85px] items-center justify-between gap-3">
            ...
            <nav class="hidden min-w-0 flex-1 items-center justify-center gap-6 lg:flex lg:gap-8" aria-label="Menu chính">
                ...
                <div class="relative group py-6">
                    <a class="inline-flex items-center gap-1.5 whitespace-nowrap text-[16px] font-extrabold transition-colors cursor-pointer <?= $isActivePage(['courses', 'course-detail']) ? 'text-blue-600' : 'text-slate-800 hover:text-blue-600' ?>" href="<?= e(page_url('courses')); ?>">
                        Chương trình học
